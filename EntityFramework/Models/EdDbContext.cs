...
namespace EntityFramework.Models
{
    public partial class EdDbContext : DbContext
    {
        ...
        public virtual DbSet<ClassesForMajorIncInstructor> ClassesForMajorIncInstructors { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Adjustment>(entity =>
            {
                ...
                entity.Property(e => e.GpaDelta).HasColumnType("decimal(5, 2)");
            ...
            modelBuilder.Entity<ClassGrade>(entity =>
            {
                entity.HasKey(e => e.Grade)
                    .HasName("PK__ClassGra__DF0ADB7B68A0FD1B");
            ...
            modelBuilder.Entity<ClassesForMajorIncInstructor>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ClassesForMajorIncInstructor");
